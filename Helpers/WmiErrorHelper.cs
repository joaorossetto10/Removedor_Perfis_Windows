...
public static class WmiErrorHelper
{
    ...
    private const int LogonFailure = unchecked((int)0x8007052E);
    ...
    private static string GetManagementMessage(ManagementException exception)
    {
        return exception.ErrorCode switch
        {
            ...
            _ when exception.HResult == LogonFailure => "Usuário ou senha inválidos para o computador remoto.",
    ...
    private static string GetComMessage(COMException exception)
    {
        return exception.HResult switch
        {
            ...
            LogonFailure => "Usuário ou senha inválidos para o computador remoto.",
            RpcServerUnavailable => "RPC indisponível. Verifique se o computador está ligado, acessível e se firewall permite WMI/RPC.",
    ...
    private static string GetWin32Message(Win32Exception exception)
    {
        return exception.NativeErrorCode switch
        {
            ...
            1326 => "Usuário ou senha inválidos para o computador remoto.",
            53 => "Computador inacessível ou caminho de rede não encontrado.",
            1722 => "RPC indisponível no computador remoto. Verifique firewall, rede e serviço WMI.",
